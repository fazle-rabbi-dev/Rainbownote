              ...
              <li key={item.id} className="">
                ...
                >
                  <span>
                    {
                      item.name === "Home" ? <Home /> :
                      item.name === "Trash" ? <Trash /> :
                      item.name === "Create" ? <PenSquare /> :
                      item.name === "Favourite" ? <Heart /> : 
                      item.name === "Source code" ? <Settings /> : 
                      item.name === "Report issue" ? <HelpCircle /> : 
                      item.name === "About" ? <Code2 /> : 
                      <Bug/>
